        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExaminerId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2024, 2, 27), false, new DateOnly(1, 1, 1), "General Knowledge", 0 },
                    { 2, new DateOnly(2024, 2, 27), false, new DateOnly(1, 1, 1), "Mathematics", 0 },
                    { 3, new DateOnly(2024, 2, 27), false, new DateOnly(1, 1, 1), "History", 0 }
                });
